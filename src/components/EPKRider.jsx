          ...
          <div className="lg:col-span-6 rounded-3xl p-6 sm:p-8 bg-[#1e1e1e]/95 border border-[#444444] shadow-2xl backdrop-blur-2xl flex flex-col justify-between">
            <div>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <span className="text-[11px] text-[#979797] font-mono font-medium">PNG, SVG Vector, 3D Alpha</span>
                    </div>
                  </div>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <span className="text-[11px] text-[#979797] font-mono font-medium">300 DPI Stage & Studio</span>
                    </div>
                  </div>
                  <Download className="w-4 h-4 text-[#979797] group-hover:text-[#E2E800] transition-colors" />
                </a>
              ...
              <div className="flex flex-col gap-3">
                <h4 className="text-xs font-mono font-black text-[#E2E800] tracking-wider uppercase">
                ...
                <div className="p-4 rounded-2xl bg-[#141414] border border-[#444444] flex items-start gap-3 shadow-inner">
                  ...
                  <div>
                    ...
                    <span className="text-xs text-[#D6D6D6] font-normal">4x Pioneer CDJ-3000 + 1x Pioneer DJM-V10 / DJM-900NXS2 (Link LAN connected).</span>
                  </div>
                </div>
                ...
                <div className="p-4 rounded-2xl bg-[#141414] border border-[#444444] flex items-start gap-3 shadow-inner">
                  ...
                  <div>
                    ...
                    <span className="text-xs text-[#D6D6D6] font-normal">2x High-end active stage monitors (d&b audiotechnik / L-Acoustics) with independent sub volume control.</span>
                  </div>
                </div>
                ...
                <div className="p-4 rounded-2xl bg-[#141414] border border-[#444444] flex items-start gap-3 shadow-inner">
                  ...
                  <div>
                    ...
                    <span className="text-xs text-[#D6D6D6] font-normal">Direct HDMI / SDI visual timecode feed for live 3D hologram stage sync + 2x 220V grounded power sockets.</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                  ...
                  <div>
                    <label className="block text-[11px] font-mono font-bold text-[#D6D6D6] uppercase mb-1.5">Kota & Negara</label>
                    <input
                      type="text"
                ...
                <button
                  type="submit"
                  className="w-full py-3.5 rounded-2xl bg-[#E2E800] hover:bg-[#f2f716] text-[#141414] font-display font-black text-xs sm:text-sm tracking-wider shadow-xl shadow-[#E2E800]/30 hover:shadow-[#E2E800]/50 hover:scale-[1.01] transition-all flex items-center justify-center gap-2 mt-2"
                >
